...
public class MergingTaskMarkerContributor implements IMarkerContributor {
  private final static Logger LOG = Logger.getLogger(MergingTaskMarkerContributor.class);
  ...
  public void updateMarkers(final IFile file, final Resource resource, final IProgressMonitor monitor) {
    try {
      ...
      if (_t instanceof CoreException) {
        ...
        MergingTaskMarkerContributor.LOG.error(e.getMessage(), e);
      } else {
